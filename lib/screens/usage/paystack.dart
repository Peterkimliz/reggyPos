...
String paystackPublicKey = 'pk_live_9f72e4e3913c4e3b155b5c4e6af7702dde1cccc4';
...
class PayStack extends StatefulWidget {
  ...
  @override
  PayStackState createState() => PayStackState();
}

class PayStackState extends State<PayStack> {
